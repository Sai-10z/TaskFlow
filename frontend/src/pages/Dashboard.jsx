    ...
    try {
      ...
      data.forEach((task) => {
        ...
        if (task.deadline) {
          ...
          if (!task.completed && deadline.getTime() === today.getTime()) {
            dueToday++;
          }

          if (!task.completed && deadline.getTime() === tomorrow.getTime()) {
            dueTomorrow++;
          }
        }
      });
      ...
      const completionRate =
        data.length === 0 ? 0 : Math.round((completed / data.length) * 100);
  ...
  const motivation = useMemo(() => {
    ...
    if (stats.pending === 0 && stats.total > 0) {
      return {
        ...
        subtitle: "Great job! You don't have any pending work right now.",
      };
    }
    ...
    <div className="dashboard-container">
      ...
      >
        <div className="dashboard-header-content">
          <div>
            ...
            <h1>
              {greeting}, <span>{user?.username || "User"}</span> 👋
            </h1>

            <p>
              Organize your work, stay on top of deadlines, and keep your
            ...
            {stats.overdue > 0 ? (
              <>
                ...
                <div>
                  ...
                  <small>Complete them as soon as possible.</small>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <h3>{stats.dueTomorrow} Due Tomorrow</h3>

                  <small>Upcoming deadlines are shown here.</small>
                </div>
              </>
            )}
          </div>
      ...
      >
        ...
        <KPICard
          ...
          trend={stats.overdue ? `${stats.overdue}` : "0"}
        ...
        <KPICard
          ...
          trend={stats.dueToday ? `${stats.dueToday}` : "0"}
      ...
      >
        <div className="overview-card glass-card">
          <div className="overview-top">
            <div>
              <span className="overview-label">Task Overview</span>
        ...
        <div className="quick-action glass-card">
          ...
          <p>
            Create, edit, organize and complete your tasks from the task board.
          </p>
